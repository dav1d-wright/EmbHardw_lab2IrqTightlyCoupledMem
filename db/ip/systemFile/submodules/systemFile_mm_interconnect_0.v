...
module systemFile_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> performance_counter_0_control_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // performance_counter_0_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> performance_counter_0_control_slave_agent:cp_channel
	...
	wire  [103:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> altpll_0_pll_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [103:0] altpll_0_pll_slave_agent_rp_data;                                          // altpll_0_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire          sdram_ctrl_s1_agent_rp_valid;                                              // SDRAM_ctrl_s1_agent:rp_valid -> router_007:sink_valid
	wire   [85:0] sdram_ctrl_s1_agent_rp_data;                                               // SDRAM_ctrl_s1_agent:rp_data -> router_007:sink_data
	wire          sdram_ctrl_s1_agent_rp_ready;                                              // router_007:sink_ready -> SDRAM_ctrl_s1_agent:rp_ready
	wire          sdram_ctrl_s1_agent_rp_startofpacket;                                      // SDRAM_ctrl_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          sdram_ctrl_s1_agent_rp_endofpacket;                                        // SDRAM_ctrl_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          leds_s1_agent_rp_valid;                                                    // LEDs_s1_agent:rp_valid -> router_008:sink_valid
	wire  [103:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_008:sink_data
	...
	wire          router_007_src_valid;                                                      // router_007:src_valid -> SDRAM_ctrl_s1_rsp_width_adapter:in_valid
	wire   [85:0] router_007_src_data;                                                       // router_007:src_data -> SDRAM_ctrl_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                      // SDRAM_ctrl_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [8:0] router_007_src_channel;                                                    // router_007:src_channel -> SDRAM_ctrl_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                              // router_007:src_startofpacket -> SDRAM_ctrl_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                                // router_007:src_endofpacket -> SDRAM_ctrl_s1_rsp_width_adapter:in_endofpacket
	wire          sdram_ctrl_s1_rsp_width_adapter_src_valid;                                 // SDRAM_ctrl_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [103:0] sdram_ctrl_s1_rsp_width_adapter_src_data;                                  // SDRAM_ctrl_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          sdram_ctrl_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_005:sink_ready -> SDRAM_ctrl_s1_rsp_width_adapter:out_ready
	wire    [8:0] sdram_ctrl_s1_rsp_width_adapter_src_channel;                               // SDRAM_ctrl_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire  [103:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> SDRAM_ctrl_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                     // SDRAM_ctrl_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> SDRAM_ctrl_s1_cmd_width_adapter:in_channel
	...
	wire  [103:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> crosser_001:in_data
	...
	wire  [103:0] crosser_001_out_data;                                                      // crosser_001:out_data -> rsp_mux:sink4_data
	...
	systemFile_mm_interconnect_0_router_003 router_004 (
	...
	systemFile_mm_interconnect_0_router_002 router_005 (
	...
	systemFile_mm_interconnect_0_router_003 router_008 (
	...
	systemFile_mm_interconnect_0_router_003 router_009 (
	...
	systemFile_mm_interconnect_0_router_003 router_010 (
	...
	systemFile_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
